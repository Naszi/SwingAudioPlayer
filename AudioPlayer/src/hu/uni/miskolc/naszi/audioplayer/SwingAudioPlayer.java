...
public class SwingAudioPlayer extends JFrame implements ActionListener {
	...
	private ImageIcon iconPlay = new ImageIcon(
			getClass().getResource("/hu/uni/miskolc/naszi/audioplayer/images/Play.gif"));
	private ImageIcon iconStop = new ImageIcon(
			getClass().getResource("/hu/uni/miskolc/naszi/audioplayer/images/Stop.gif"));
	...
	private void openFile() {
		...
		FileFilter wawFilter = new FileFilter() {
		...
		fileChooser.setFileFilter(wawFilter);
		...
		playbackThread = new Thread(new Runnable() {
			...
			public void run() {
				try {
					...
					JOptionPane.showMessageDialog(SwingAudioPlayer.this, "The audio format is unsupported!", "Error",
					...
					JOptionPane.showMessageDialog(SwingAudioPlayer.this, "I/O error while playing the audio file!",
